	...
	<?php
		if(isset($_POST['submit'])){
		      ...
		      $Password = mysqli_real_escape_string($db->link, $_POST['Password']);
			   ...
			   $query= "INSERT INTO postsell(First_Name,Last_Name,User_Name,E_mail,Phone_Number,Sell_Post,Product_Id,price,Address, Password) Values('$First_Name', '$Last_Name', '$User_Name', '$E_mail', '$Mobile', '$sell', '$Product_Id','$price','$Address', '$Password')";
